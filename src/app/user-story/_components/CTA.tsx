            ...
            <div className="container mx-auto px-6">
                <div className="bg-[#1C302B] rounded-3xl p-8 md:p-16 relative overflow-hidden text-center">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        <h2 className="font-serif text-3xl md:text-5xl text-white mb-6">Mulai Kisah Anda Sendiri</h2>
                        <p className="text-white/80 text-lg mb-10 leading-relaxed">
                            Bergabunglah dengan komunitas inovator, pemikir, dan pemimpin. Daftar hari ini dan ambil langkah pertama menuju masa depan Anda.
                        </p>
