            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-lg">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-eduzin-dark dark:text-green-400 font-medium mb-4">Spesialis Penelitian AI & Teknolog Pendidikan</p>
                        <p className="text-gray-600 dark:text-gray-400 italic mb-6">
                            "Alat AI seperti NotebookLM merevolusi cara kita berinteraksi dengan informasi. Kursus ini dirancang untuk membantu Anda memanfaatkan teknologi canggih ini sambil mempertahankan keterampilan berpikir kritis yang penting untuk penelitian berkualitas."
                        </p>
