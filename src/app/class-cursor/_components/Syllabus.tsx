                        ...
                        <div key={index} className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md transition-all">
                            ...
                            >
                                <div className="flex items-center gap-6">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-teal-700/10 dark:bg-teal-700/20 flex items-center justify-center text-teal-700 dark:text-teal-400 font-bold font-serif text-xl">
                                        {week.number}
                                    </div>
                                    <div>
                            ...
                            {openWeek === index && (
                                <div className="px-6 pb-6 pt-0 ml-[4.5rem] border-l-2 border-teal-700/10 dark:border-teal-700/20">
