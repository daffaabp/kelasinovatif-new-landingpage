            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
                    ...
                    <div className="flex gap-2 mt-4 md:mt-0">
                        ...
                        <button 
                            onClick={nextSlide}
                            className="w-10 h-10 rounded-full bg-gradient-to-r from-teal-700 to-teal-800 text-white flex items-center justify-center hover:from-teal-800 hover:to-teal-900 transition shadow-lg"
                ...
                <div className="relative overflow-hidden">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {currentTestimonials.map((testimonial, index) => (
                            <div key={currentSlide * itemsPerSlide + index} className="bg-gray-50 dark:bg-gray-900 p-8 rounded-2xl relative border-2 border-transparent hover:border-teal-200 dark:hover:border-teal-900 transition-all duration-300 animate-in fade-in slide-in-from-right-4 duration-500">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-800 dark:to-teal-900 flex items-center justify-center ring-2 ring-teal-300 dark:ring-teal-700">
