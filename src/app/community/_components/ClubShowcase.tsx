            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                    <div className="max-w-2xl">
                        <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Temukan Niche Anda</h2>
                        <p className="text-gray-600 dark:text-gray-400">Baik Anda tertarik dengan robotika, debat, atau aktivisme lingkungan, ada tempat untuk Anda di sini.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <a className="group block overflow-hidden rounded-xl bg-white dark:bg-community-card-dark shadow hover:shadow-lg transition-all" href="#">
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <span className="absolute top-4 left-4 bg-community-primary text-white text-xs font-bold px-2 py-1 rounded">Teknologi</span>
                        </div>
                        <div className="p-5">
                            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-2">Innovators Hub</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">Tantangan coding mingguan dan hackathon untuk calon pengembang.</p>
                            <div className="mt-4 flex items-center text-xs text-gray-500 dark:text-gray-400">
                                <span className="material-icons-outlined text-sm mr-1">group</span> 240 Anggota
                            </div>
                        </div>
                    </a>
                    <a className="group block overflow-hidden rounded-xl bg-white dark:bg-community-card-dark shadow hover:shadow-lg transition-all" href="#">
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span className="absolute top-4 left-4 bg-orange-600 text-white text-xs font-bold px-2 py-1 rounded">Seni &amp; Budaya</span>
                        </div>
                        <div className="p-5">
                            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-2">Canvas Collective</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">Eksplorasi dalam seni digital, lukisan, dan patung modern.</p>
                            <div className="mt-4 flex items-center text-xs text-gray-500 dark:text-gray-400">
                                <span className="material-icons-outlined text-sm mr-1">group</span> 115 Anggota
                            </div>
                        </div>
                    </a>
                    <a className="group block overflow-hidden rounded-xl bg-white dark:bg-community-card-dark shadow hover:shadow-lg transition-all" href="#">
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span className="absolute top-4 left-4 bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded">Debat</span>
                        </div>
                        <div className="p-5">
                            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-2">The Forum</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">Terlibat dalam wacana terstruktur tentang politik dan ekonomi global.</p>
                            <div className="mt-4 flex items-center text-xs text-gray-500 dark:text-gray-400">
                                <span className="material-icons-outlined text-sm mr-1">group</span> 85 Anggota
                            </div>
                        </div>
                    </a>
                    <a className="group block overflow-hidden rounded-xl bg-white dark:bg-community-card-dark shadow hover:shadow-lg transition-all" href="#">
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span className="absolute top-4 left-4 bg-green-600 text-white text-xs font-bold px-2 py-1 rounded">Eko</span>
                        </div>
                        <div className="p-5">
                            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-2">Green Campus</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">Inisiatif untuk membuat kampus kami netral karbon dan zero waste.</p>
                            <div className="mt-4 flex items-center text-xs text-gray-500 dark:text-gray-400">
                                <span className="material-icons-outlined text-sm mr-1">group</span> 320 Anggota
                            </div>
                        </div>
                    </a>
                </div>
