        ...
        <form action="#" className="space-y-6" method="POST">
            <div>
                ...
                <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                        className="focus:ring-[#2F4F4F] focus:border-[#2F4F4F] block w-full pl-10 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md py-2.5 bg-gray-50 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 transition-colors focus:outline-none focus:ring-1"
                        id="email"
                        name="email"
            ...
            <div>
                ...
                <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                        className="focus:ring-[#2F4F4F] focus:border-[#2F4F4F] block w-full pl-10 pr-10 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md py-2.5 bg-gray-50 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 transition-colors focus:outline-none focus:ring-1"
                        id="password"
                        name="password"
                        placeholder="••••••••"
