...
const testimonialData: TestimonialData[] = [
  {
    ...
    quote: "Belajar di Kelas Inovatif telah menjadi pengalaman yang mengubah hidup. Fakultas sangat mendukung, dan kursusnya menantang sekaligus menginspirasi. Saya berkembang tidak hanya secara akademis, tetapi juga secara pribadi, berkat kehidupan kampus yang dinamis.",
