            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative z-10">
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <h1 className="text-4xl md:text-6xl font-serif text-white mb-6 leading-tight">
                        Bentuk Masa Depan <br /><span className="italic text-white/90">Pembelajaran Inovatif</span>
                    </h1>
                    <p className="text-lg md:text-xl text-gray-300 mb-10 font-light leading-relaxed">
                        Bergabunglah dengan tim visioner yang berdedikasi untuk mendefinisikan ulang pendidikan melalui teknologi. Kami mencari individu yang penuh semangat untuk membantu membangun generasi berikutnya dari alat pembelajaran.
                    </p>
