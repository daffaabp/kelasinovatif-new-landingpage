        ...
        <div className="relative h-80 w-full overflow-hidden">
            ...
            <div className="absolute inset-0 bg-eduzin-dark/40 flex items-center justify-center">
                <div className="text-center px-4">
                    <h2 className="text-3xl md:text-4xl font-serif text-white mb-2">"Tempat terbaik untuk berinovasi ada di sini."</h2>
                    <p className="text-white/90 text-sm md:text-base font-light italic">— Dr. Sarah Jenkins, Kepala Penelitian AI</p>
                </div>
            </div>
        </div>
    );
