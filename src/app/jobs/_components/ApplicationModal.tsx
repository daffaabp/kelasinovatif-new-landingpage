                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">PDF, DOC, atau DOCX (maks. 5MB)</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Ceritakan mengapa Anda cocok untuk peran ini..."
                            />
                        </div>
                    </div>
